...
const OPTIONAL: {
  ...
  },
  {
    ...
    date: 'Thursday 20 August',
    description:
      'An 18-hole, par-72 layout designed by renowned architect Max Wexler. Set in a lush tropical setting across 165 acres of greenery. Guests must hold an official handicap card or National Handicapping System number (Men: 24 and below · Ladies: 36 and below).',
    min: 10,
    max: 20,
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="px-4 py-4 space-y-5 pb-8">
        ...
        <section>
          ...
          <p className="text-xs text-gray-500 mb-3 -mt-1 ml-7">
